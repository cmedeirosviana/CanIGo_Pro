...
public final class Script_Photo {
    ...
    public static abstract class FeedEntry implements BaseColumns
    {
        ...
        public static final String COLUMN_VOTESPOS = "VOTESPOS";
        public static final String COLUMN_VOTESNEG = "VOTESNEG";
    ...
    public static final String SQL_CREATE_ENTRIES =
            "CREATE TABLE " + FeedEntry.TABLE_NAME + "(" +
                    ...
                    FeedEntry.COLUMN_VOTESPOS + TEXT_TYPE + COMMA_SEP +
                    FeedEntry.COLUMN_VOTESNEG + TEXT_TYPE +
                    " )";
